            ...
            <div className = "w flex center content-box-main">
                <div className = "content-box">
                    ...
                    <div className = "ques">
                        ...
                        <p>我是一名前端开发工程师，主要写 JavaScript，有大概两年经验。最近在写一些页面上的模块，发现自己在构思的时候总是很清晰，但是写着写着感觉代码越来越乱，
                        ...
                        <div className = "ques-footer">
                            <a href="javascript:void(0)" className="btn"><i></i>12条评论</a>
                            <a href="javascript:void(0)" className="btn"><i></i>分享</a>
